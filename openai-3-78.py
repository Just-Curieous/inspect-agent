...
# https://github.com/UKGovernmentBEIS/inspect_ai/blob/main/src/inspect_ai/model/_providers/openai.py
# https://github.com/UKGovernmentBEIS/inspect_ai/releases/tag/0.3.78
